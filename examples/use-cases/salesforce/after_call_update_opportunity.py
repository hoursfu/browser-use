...
async def main():
    ...
    task = (
        ...
        "   - Stage (dropdown): Negotiate"
        "   - Amount (text field): 58000"
        "   - Next Step (text field): send security questionnaire by Friday"
        "3) Click the blue save button."
        "4) Click the triangle button next to Contact Roles to Add Contact Role"
        "   - Check the checkbox next to Salima Mangalji"
        "   - Click the next button"
        "   - Set Salima Mangalji's role as Decision Maker"
